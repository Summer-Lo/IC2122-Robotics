...
class Move:
    ...
    def setJointAngle1(self,joint1,joint2,joint3,joint4,joint5,joint6):
        clientID = self.clientID
        RAD2DEG = self.RAD2DEG
        jointHandle = self.jointHandle
        jointConfig = self.jointConfig
        jointAngle = [joint1,joint2,joint3,joint4,joint5,joint6]
        for i in range(6):
            _ = vrep.simxSetJointTargetPosition(clientID, jointHandle[i], (jointAngle[i]/RAD2DEG), vrep.simx_opmode_blocking)
            #print(_)
        self.jointConfig = jointConfig

    def setJointAngle0(self,joint1,joint2,joint3,joint4,joint5,joint6):
        clientID = self.clientID
        RAD2DEG = self.RAD2DEG
        jointHandle0 = self.jointHandle0
        jointConfig0 = hc.jointConfig0
        jointAngle = [joint1,joint2,joint3,joint4,joint5,joint6]
        jointConfig0 = jointAngle
        #joint1 = int(input("Input Joint 1 Angle: "))
        #joint2 = int(input("Input Joint 2 Angle: "))
        #joint3 = int(input("Input Joint 3 Angle: "))
        #joint4 = int(input("Input Joint 4 Angle: "))
        ...
        #joint6 = int(input("Input Joint 6 Angle: "))
        for i in range(6):
            _ = vrep.simxSetJointTargetPosition(clientID, jointHandle0[i], jointAngle[i]/RAD2DEG, vrep.simx_opmode_blocking)
            #print(_)
    ...
    def setTarget0(self):
        ...
        position = [float(PosX),float(PosY),float(PosZ)]
        orientation = [float(Alpha),float(Beta),float(Gamma)]
        vrep.simxSetObjectPosition(clientID, targetHandle0, -1, position, vrep.simx_opmode_blocking)
        vrep.simxSetObjectOrientation(clientID, targetHandle0, -1, orientation, vrep.simx_opmode_blocking)


    def setTargetPosition0(self):
        clientID = self.clientID
        RAD2DEG = self.RAD2DEG
        targetHandle0 = self.targetHandle0
        PosX = float(input("Input Position X: "))
    ...
    def setTargetOrientation0(self):
        clientID = self.clientID
        RAD2DEG = self.RAD2DEG
        targetHandle0 = self.targetHandle0
        Alpha = float(input("Input Orientation Alpha (in degree): "))/RAD2DEG
